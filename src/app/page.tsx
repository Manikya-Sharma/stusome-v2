        ...
        <div className="pl-3">
          ...
          <div className="mt-24">
            ...
            <p className="mt-3 pl-1 pr-5 text-lg font-light text-black/80 dark:text-white/80">
              ...
              of social media while retaining its original character. We want
              the future generation to create a{" "}
              <span className="text-blue-600 dark:text-blue-400">
            ...
            <ul className="text-black/75 dark:text-white/75">
              <li className="my-5">
                ...
                <p className="ml-3 max-w-prose leading-relaxed">
                  ...
                  can write in simple markdown, out app will automatically
                  extract headings and topics from it.
                  <br />
              ...
              <li className="my-5">
                <h3 className="mb-2 mt-3 pl-3 text-4xl tracking-wide">
                  Doubts
                </h3>
                <p className="ml-3 max-w-prose leading-relaxed">
                  Confused? No more! With our doubts feature, you can freely
                  post any question. We make sure that your doubt comes at the
                  top of other&apos;s feed.
                  <br />
              ...
              <li className="my-5">
                ...
                <p className="ml-3 max-w-prose leading-relaxed">
                  ...
                  provide state-of-the-art real-time chat experience for free!
                  To avoid spamming, you can chat with either an author or with
                  a person whose email you know.
                </p>
              </li>
            </ul>
          </div>
